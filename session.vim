...
silent only
cd C:\archive\flash\subtletea\src\com\finegamedesign\subtletea
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 \archive\flash\subtletea\notes.txt
badd +1 AirPocketClip.as
badd +1 DiverClip.as
badd +1 KelpClip.as
badd +18 LevelLoader.as
badd +37 LevelSelect.as
badd +141 Main.as
badd +116 Model.as
badd +1 PearlClip.as
badd +1 Shark.as
...
badd +23 Controller.as
args AirPocketClip.as DiverClip.as KelpClip.as LevelLoader.as LevelSelect.as Main.as Model.as PearlClip.as Shark.as SharkClip.as View.as
edit \archive\flash\subtletea\notes.txt
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((9 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
normal! 06l
tabedit Controller.as
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 121 - ((7 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
121
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 113 - ((8 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
